package com.gproject.common.utils.date;
...
public class DateUtils {
	 ...
	 * 一分钟的秒数
	 */
	public static final long ONE_MINUTE_SECOND = ONE_MINUTE_MILLISECOND / ONE_SECOND_MILLISECOND;
	...
	public static String formter(Date dateTime) {
		DateFormat sFormat = new SimpleDateFormat(DatePattern.PATTERN_NORMAL);
